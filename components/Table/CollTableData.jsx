...
const CollTableData = ({type,users,finishindex,startindex,selectUser,setDetailview}) => {
                  ...
                  <tr key={i} onMouseEnter={()=>{setDetailview("userview");selectUser(user)}}>
                    ...
                    </td>
                    {
                      ...
                      <>
                        ...
                        <td class="sm:p-3 py-2 px-1 border-b border-gray-800" > {user?.satchargeday}</td>
                      </>
                      :
                      <>
