...
const Sidebar = () => {
    ...
    if(data){
  return (
    <div class="bg-gray-900 border-gray-800 w-20 flex-shrink-0 border-r  flex-col hidden sm:flex">
        ...
        <button class="h-10 w-12 text-gray-500 rounded-md flex items-center justify-center">
        ...
        <button class="h-10 w-12 bg-gray-700 text-gray-400 rounded-md flex items-center justify-center">
            <svg viewBox="0 0 24 24" class="h-5" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
